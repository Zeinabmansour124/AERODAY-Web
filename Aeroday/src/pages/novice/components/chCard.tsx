      ...
      >
        ...
        <div
          style={{
            height: "220px",
            background:
              "linear-gradient(180deg, #0f172a 0%, #1e293b 20%, #0f3460 50%, #0a3d4d 75%, #065a60 100%)",
            position: "relative",
            overflow: "hidden",
            perspective: "1000px",
          }}
        >
          ...
          <div
            style={{
              ...
              top: "15px",
              right: "10%",
              animation: "cloudFloat 14s ease-in-out infinite 3s",
            }}
          >
            <div
              style={{
          ...
          <div
            style={{
              ...
              top: "5px",
              left: "50%",
              animation: "cloudFloat 10s ease-in-out infinite 1.5s",
            }}
          >
            <div
              style={{
          ...
          <div
            style={{
              ...
              height: "60px",
              background:
                "linear-gradient(180deg, #fff 0%, rgba(255,255,255,0.6) 50%, transparent 100%)",
              clipPath:
                "polygon(40% 0, 60% 0, 50% 40%, 70% 40%, 30% 100%, 45% 100%, 55% 50%, 35% 50%)",
              animation: "lightningFlash 5s ease-in-out infinite",
              filter:
                "drop-shadow(0 0 8px #fff) drop-shadow(0 0 20px rgba(255,255,255,0.8))",
            }}
          />
          <div
            style={{
              ...
              height: "50px",
              background:
                "linear-gradient(180deg, #fff 0%, rgba(255,255,255,0.5) 50%, transparent 100%)",
              clipPath:
                "polygon(40% 0, 60% 0, 45% 35%, 65% 35%, 25% 100%, 40% 100%, 55% 45%, 35% 45%)",
              animation: "lightningFlash 7s ease-in-out infinite 2s",
          ...
          >
            <div
              style={{
                ...
                height: "20px",
                background:
                  "linear-gradient(180deg, rgba(180,200,210,0.6), rgba(8,100,110,0.4))",
          ...
          <div
            style={{
              ...
              top: "10px",
              left: "25%",
              animation: "rainDrop 0.9s linear infinite 0.15s",
            }}
          >
            <div
              style={{
                ...
                height: "18px",
                background:
                  "linear-gradient(180deg, rgba(180,200,210,0.5), rgba(8,100,110,0.3))",
                borderRadius: "2px 2px 50% 50%",
              }}
            />
          </div>
          <div
            style={{
              ...
              top: "30px",
              left: "40%",
              animation: "rainDrop 1.1s linear infinite 0.4s",
            }}
          >
            <div
              style={{
          ...
          <div
            style={{
              ...
              top: "15px",
              left: "58%",
              animation: "rainDrop 0.8s linear infinite 0.6s",
            }}
          >
            <div
              style={{
          ...
          <div
            style={{
              ...
              top: "25px",
              left: "72%",
              animation: "rainDrop 1.0s linear infinite 0.25s",
            }}
          >
            <div
              style={{
          ...
          <div
            style={{
              ...
              top: "5px",
              left: "85%",
              animation: "rainDrop 0.9s linear infinite 0.8s",
            }}
          >
            <div
              style={{
                ...
                height: "15px",
                background:
                  "linear-gradient(180deg, rgba(180,200,210,0.4), rgba(8,100,110,0.2))",
                borderRadius: "2px 2px 50% 50%",
              }}
            />
          </div>
          <div
            style={{
              ...
              top: "35px",
              left: "15%",
              animation: "rainDrop 1.2s linear infinite 0.05s",
            }}
          >
            <div
              style={{
          ...
          <div
            style={{
              ...
              top: "12px",
              left: "48%",
              animation: "rainDrop 1.0s linear infinite 0.5s",
            }}
          >
            <div
              style={{
          ...
          >
            <div
              style={{ position: "relative", width: "60px", height: "20px" }}
            >
              {/* Corps */}
              <div
                style={{
              ...
              <div
                style={{
                  ...
                  width: "16px",
                  height: "8px",
                  background: "linear-gradient(0deg, #cbd5e1, #94a3b8)",
              ...
              <div
                style={{
                  ...
                  background: "#ef4444",
                  borderRadius: "50%",
                  animation: "planeBlink 1s ease-in-out infinite",
              ...
              <div
                style={{
                  ...
                  background: "#22c55e",
                  borderRadius: "50%",
                  animation: "planeBlink 1s ease-in-out infinite 0.5s",
            ...
            >
              ...
              <div
                style={{
                  ...
                  background: "#94a3b8",
                  borderRadius: "2px",
                  animation: "dronePropeller 0.08s linear infinite 0.02s",
                }}
              />
              <div
                style={{
                  ...
                  background: "#94a3b8",
                  borderRadius: "2px",
                  animation: "dronePropeller 0.08s linear infinite 0.04s",
                }}
              />
              <div
                style={{
                  ...
                  background: "#94a3b8",
                  borderRadius: "2px",
                  animation: "dronePropeller 0.08s linear infinite 0.06s",
                }}
              />
              {/* Corps central */}
              <div
              ...
              <div
                style={{
                  ...
                  height: "80px",
                  background:
                    "linear-gradient(180deg, rgba(0,212,255,0.15) 0%, transparent 100%)",
          ...
          >
            <path
              d="M 50 220 L 80 180 L 70 150 L 100 120 L 90 80 L 130 40"
              fill="none"
              stroke="rgba(0,0,0,0.5)"
              strokeWidth="2"
              strokeDasharray="200"
              strokeDashoffset="0"
              style={{ animation: "crackAppear 3s ease-out infinite" }}
            />
            <path
              d="M 80 180 L 110 190 L 140 170"
              fill="none"
              stroke="rgba(0,0,0,0.4)"
              strokeWidth="1.5"
              strokeDasharray="150"
              strokeDashoffset="0"
              style={{ animation: "crackAppear 3s ease-out infinite 0.5s" }}
            />
            <path
              d="M 700 220 L 670 190 L 680 160 L 650 130 L 660 90 L 620 50"
              fill="none"
              stroke="rgba(0,0,0,0.45)"
              strokeWidth="2"
              strokeDasharray="200"
              strokeDashoffset="0"
              style={{ animation: "crackAppear 3.5s ease-out infinite 1s" }}
            />
            <path
              d="M 670 190 L 640 200 L 610 185"
              fill="none"
              stroke="rgba(0,0,0,0.35)"
              strokeWidth="1.5"
              strokeDasharray="120"
              strokeDashoffset="0"
              style={{ animation: "crackAppear 3.5s ease-out infinite 1.3s" }}
            />
            <path
              d="M 350 220 L 370 200 L 360 170 L 390 140 L 380 100"
              fill="none"
              stroke="rgba(0,0,0,0.3)"
              strokeWidth="1.5"
              strokeDasharray="180"
              strokeDashoffset="0"
              style={{ animation: "crackAppear 4s ease-out infinite 2s" }}
            />
          </svg>
          ...
          >
            <div
              style={{
                ...
                borderRadius: "50%",
                animation: "seismicWave 2s ease-out infinite",
              }}
            />
            <div
              style={{
                ...
                borderRadius: "50%",
                animation: "seismicWave 2s ease-out infinite 0.6s",
              }}
            />
            <div
              style={{
                ...
                borderRadius: "50%",
                animation: "seismicWave 2s ease-out infinite 1.2s",
              }}
            />
          </div>
          <div
          ...
          >
            <div
              style={{
                ...
                borderRadius: "50%",
                animation: "seismicWave 2.5s ease-out infinite 0.3s",
              }}
            />
            <div
              style={{
                ...
                borderRadius: "50%",
                animation: "seismicWave 2.5s ease-out infinite 0.9s",
              }}
            />
          </div>
            ...
            >
              <div
                style={{
                  ...
                  height: "70px",
                  background:
                    "linear-gradient(180deg, #2d3436 0%, #1a1a2e 100%)",
                  borderRadius: "2px",
          ...
          <div
            style={{
              ...
              width: "100%",
              height: "55px",
              animation: "floodRise 3s ease-in-out infinite",
              zIndex: 3,
            }}
          >
            <svg
            ...
            >
              <path
                d="M0 25 Q 40 15, 80 25 T 160 25 T 240 22 T 320 25 T 400 28 T 480 25 T 560 23 T 640 25 T 720 27 T 800 25 V 55 H 0 Z"
                fill="rgba(6,90,96,0.65)"
              />
              <path
                d="M0 35 Q 50 25, 100 35 T 200 35 T 300 32 T 400 35 T 500 38 T 600 35 T 700 33 T 800 35 V 55 H 0 Z"
                fill="rgba(8,126,139,0.45)"
              />
              <path
                d="M0 45 Q 60 38, 120 45 T 240 43 T 360 45 T 480 47 T 600 45 T 720 44 T 800 45 V 55 H 0 Z"
                fill="rgba(10,150,160,0.25)"
              />
            </svg>
          </div>
          ...
          <div
            style={{
              ...
              top: "20px",
              left: "35%",
              animation: "debrisFall 3s linear infinite",
            }}
          >
            <div
              style={{
          ...
          <div
            style={{
              ...
              top: "10px",
              left: "62%",
              animation: "debrisFall 2.5s linear infinite 0.7s",
            }}
          >
            <div
              style={{
          ...
          <div
            style={{
              ...
              top: "30px",
              left: "48%",
              animation: "debrisFall 3.5s linear infinite 1.2s",
            }}
          >
            <div
              style={{
          ...
          <div
            style={{
              ...
              top: "15px",
              left: "78%",
              animation: "debrisFall 2.8s linear infinite 0.4s",
            }}
          >
            <div
              style={{
          ...
          >
            <div className="row align-items-center">
              ...
              <div className="col-lg-8 col-md-7">
                ...
                >
                  Les Ateliers Novices sont conçus pour les jeunes débutants en
                  aéronautique, âgés de 6 à 17 ans. Au programme: Défis en
                  aéromodélisme, Aero Entrepreneure Junior et CAO — des
                  activités adaptées à chaque âge pour apprendre, imaginer et
                  s'envoler vers l'innovation!
                </ul>
              </div>
